...
export const PLAYER_HARD_FIELD_OF_VIEW = CELL_SIZE * 3;
export const PLAYER_SOFT_FIELD_OF_VIEW = CELL_SIZE * 5;
...
export const PROJECTILE_HARD_FIELD_OF_VIEW = CELL_SIZE * 1;
export const PROJECTILE_SOFT_FIELD_OF_VIEW = CELL_SIZE * 2;
